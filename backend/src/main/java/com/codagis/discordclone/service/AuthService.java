...
public class AuthService {
    ...
    /** ADMIN edita username/email/role/senha de uma conta (senha em branco = mantem a atual). */
    @Transactional
    public UserResponse updateUserAsAdmin(Long requesterId, Long targetUserId, UpdateUserRequest req) {
        ...
        // Rebaixar o UNICO admin trancaria o painel pra sempre (ninguem mais poderia
        // promover ninguem de volta) - protege contra isso.
    ...
    /** ADMIN exclui uma conta. Nao deixa se auto-excluir nem excluir o unico admin restante. */
    @Transactional
