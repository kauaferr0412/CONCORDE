...
/**
 * Autentica a conexao STOMP no CONNECT lendo o header "Authorization: Bearer <jwt>"
 * (o cliente React manda isso ao abrir o socket). Sem isso o WebSocket ficaria aberto.
 */
@Component
